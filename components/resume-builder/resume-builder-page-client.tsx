...
function ResumeBuilderContent() {
  ...
  const [resumeData, setResumeData] = useState<ResumeData>({
    ...
    summary:
      "Experienced professional with a strong background in software development and problem solving.",
    education: [
      {
      ...
      if (response.ok) {
        setChatHistory((prev) => [
          ...prev,
          {
            role: "ai",
            message:
              "I've analyzed your request! Your resume will be updated based on your instructions.",
          },
        ]);
        ...
        setChatHistory((prev) => [
          ...prev,
          { role: "ai", message: "Sorry, I encountered an error." },
        ]);
      }
    } catch (error) {
      setChatHistory((prev) => [
          ...
          <div className="p-4 sm:p-6 border-b bg-white flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-xs sm:text-sm text-gray-600">
                Tell me what to change in your resume
              </p>
            </div>
          ...
          <ScrollArea className="flex-1 p-3 sm:p-4">
            <div className="space-y-3 sm:space-y-4">
              ...
              {chatHistory.map((msg, i) => (
                <div
                  key={i}
                  className={`p-2 sm:p-3 rounded-lg ${msg.role === "user" ? "bg-blue-100 ml-2 sm:ml-4" : "bg-white mr-2 sm:mr-4 shadow-sm"}`}
                >
                ...
                <div className="flex items-center gap-2 flex-1">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600">
                      Click any text to edit directly • Changes save
                      automatically
                    </p>
                  </div>
                </div>
